...
::: tip
Frida API 根据李玺 [LxTools](http://www.cnlans.com/lx/tools/frida)、r0ysue [AndroidSecurityStudy](https://github.com/r0ysue/AndroidSecurityStudy) 以及[官方文档](https://frida.re/docs/javascript-api/)整理而成。
:::
